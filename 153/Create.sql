...
USE zahnarztpraxis_nachSpezialisierung;
 ...
 CREATE TABLE Adresse(AdressID BIGINT NOT NULL IDENTITY(1,1),
	 Strasse varchar(255),
...
CREATE TABLE Patient (PatientID BIGINT NOT NULL IDENTITY(1,1),
	...
	CONSTRAINT fk_patient_adresse FOREIGN KEY (AdressID) REFERENCES Adresse(AdressID)
	);
...
CREATE TABLE Mitarbeiter(MitarbeiterID BIGINT NOT NULL IDENTITY(1,1) ,
	...
	CONSTRAINT fk_mitarbeiter_adresse FOREIGN KEY (AdressID) REFERENCES Adresse(AdressID),
